...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $content = [
            ...
            'img' => '/storage/images/sushi.jpg'
        ];
        DB::table('shops')->insert($content);
        $content = [
            'owner_id' => 2,
            'name' => '牛助',
            'area_id' => 2,
            ...
            'img' => '/storage/images/yakiniku.jpg'
        ];
        DB::table('shops')->insert($content);
        $content = [
            'owner_id' => 3,
            ...
            'img' => '/storage/images/izakaya.jpg'
        ];
        DB::table('shops')->insert($content);
        $content = [
            'owner_id' => 4,
            ...
            'img' => '/storage/images/italian.jpg'
        ];
        DB::table('shops')->insert($content);
        $content = [
            'owner_id' => 5,
